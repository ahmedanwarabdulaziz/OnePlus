    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#0f1b4b] py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#701621] rounded-full translate-x-1/2 translate-y-1/2" />
        </div>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          {Array.from({ length: SECTIONS }, (_, i) => i + 1).map((n) => {
            const title = t(`privacy.s${n}Title`);
            const content = t(`privacy.s${n}Content`);
